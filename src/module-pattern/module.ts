...
// Example usage:
/*
console.log(KiranaStore.addItems("Alice", 50, "Rice"));
console.log(KiranaStore.addItems("Bob", 30, "Wheat"));
console.log(KiranaStore.count());
console.log(KiranaStore.getGodownItems());
console.log(KiranaStore.sellItems("Charlie", 20, "Rice"));
console.log(KiranaStore.count());
console.log(KiranaStore.sellItems("Dave", 70, "Wheat"));
console.log(KiranaStore.count());

console.log(KiranaStore.deleteItems("Eve", "Wheat"));
console.log(KiranaStore.count());

console.log(KiranaStore.updateItems("Frank", "Rice", 40));
console.log(KiranaStore.count());
*/
// console.log("Direct godown: ", typeof KiranaStore.godownItemsCount); // Property 'godownItemsCount' does not exist on type
// console.log("ItemsCount: ", typeof KiranaStore.itemsCount); // Property 'itemsCount' does not exist on type
